...
export default function PageActivites() {
  ...
  const { data, isLoading, error } = useActivites({ page, recherche: rechercheDebounce, type: filtreType, brancheType: filtreBranche })
  const supprimerActivite = useSupprimerActivite()

  useEffect(() => { setPage(1) }, [rechercheDebounce])
